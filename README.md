...
Variant RegEx is used to get the name of the variant for display. It **must** include at least one capture group, the first of which should contain the variant name.
